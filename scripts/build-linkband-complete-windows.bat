...
if %errorlevel% equ 0 (
    ...
    node --version
    npm --version
    echo CONTINUE: Proceeding to Git check...
    goto :check_git
)
...
echo Link Band SDK v1.0.1 Windows Build > "%ORIGINAL_DIR%output\windows\BUILD_INFO.txt"
